# Домашнее задание к занятию «Система мониторинга Zabbix. Часть 2» - `Федоров Дмитрий`
...
#### Требования к результату
Скриншот страницы хостов, где будут видны привязки шаблонов с названиями «Задание 2-3». Хосты должны иметь зелёный статус подключения
...
#### Требования к результату
Скриншот дашборда
![alt text](https://github.com/fin4457/zabbix_2/blob/main/img/dashboard.jpg)
